...
## Quick use:
- download this repo
- if you are on windows, double click: run_project.bat; ; refresh the web it if backend is offline
- if you are on macOS/Linux, run run_project.sh; refresh the web if backend is offline
